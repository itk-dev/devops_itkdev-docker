...
(cd php7.3-blackfire && docker build --no-cache --tag=itkdev/php7.3-fpm:blackfire .)
...
(cd supervisor && docker build --no-cache --build-arg VERSION=7.4 --tag=itkdev/supervisor-php7.4:alpine .)
(cd supervisor && docker build --no-cache --build-arg VERSION=8.0 --tag=itkdev/supervisor-php8.0:alpine .)
(cd supervisor && docker build --no-cache --build-arg VERSION=8.1 --tag=itkdev/supervisor-php8.1:alpine .)
